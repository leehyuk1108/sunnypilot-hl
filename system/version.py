...
RELEASE_BRANCHES = ['release-c3-hl', 'release3-staging', 'dashcam3-staging', 'release3', 'dashcam3', 'nightly']
TESTED_BRANCHES = RELEASE_BRANCHES + ['release-c3-hl', 'devel', 'devel-staging', 'staging-c3', 'release-c3']
